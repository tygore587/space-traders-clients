...
export const SideNav = (props:any) =>
{
    ...
    return (
        <div className="flex flex-col justify-between bg-slate-800 text-zinc-50 h-full">
            <nav className="top-0 md:top-16 pl-[1em]">
                <ul className="list-disc list-inside py-2 flex flex-col gap-2 marker:text-orange-500">
